...
<h2>Online-Tutor-API-v1||Retrieve all subjects API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve a subject API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve all categories API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve all Tutors API</h2>
...
<h2>Online-Tutor-API-v1||Create a Subject API</h2>
...
<h2>Online-Tutor-API-v1||Update a Subject API</h2>
<p> The <strong>Update a Subject API</strong> enables a registered admin to update a subject by Id in the database. Please, fill in the <strong>x-www-form-urlencoded</strong> in the <strong>body</strong> section and also the token given on <strong>Login</strong> should be copied to the <strong>Bearer Token</strong> in the <strong>Authorization</strong> section.</p>
...
<h2>Online-Tutor-API-v1||Delete a Subject API</h2>
<p> The <strong>Delete a Subject API</strong> enables a registered admin to delete a subject by Id in the database. Please, fill in the <strong>x-www-form-urlencoded</strong> in the <strong>body</strong> section and also the token given on <strong>Login</strong> should be copied to the <strong>Bearer Token</strong> in the <strong>Authorization</strong> section.</p>
...
<h2>Online-Tutor-API-v1||Create a Category API</h2>
...
<h2>Online-Tutor-API-v1||Update a Category API</h2>
...
<h2>Online-Tutor-API-v1||Delete a Category API</h2>
...
<h2>Online-Tutor-API-v1||Book a Lesson API</h2>
...
<h2>Online-Tutor-API-v1||Update a Lesson API</h2>
...
<h2>Online-Tutor-API-v1||Delete a Lesson API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve a Lesson API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve all Lessons API</h2>
...
<h2>Online-Tutor-API-v1||Update a Tutor API</h2>
...
<h2>Online-Tutor-API-v1||Retrieve a Tutor API</h2>
